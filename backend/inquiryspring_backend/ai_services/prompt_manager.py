...
class PromptManager:
    ...
    def _get_or_create_examples(example_type: str) -> List[Dict]:
        ...
        if example_type == 'quiz':
            ...
            examples = [{
                "summary": "本文档主要介绍了人工智能的基础概念和应用领域。首先，文档定义了AI是模拟人类智能的计算机系统，包括机器学习、深度学习和自然语言处理等核心技术。其次，文档讨论了AI在医疗、金融、教育和交通等领域的应用案例。最后，文档分析了AI发展面临的伦理挑战和未来趋势。"
            }]
        ...
        templates_to_create = {
            'chat': {
                ...
                'content': """你是一个专业的学习助手。
                            ...
                            2. 不要编造不在参考资料中的信息。如果参考资料不足以回答问题，请明确说明。
